/*
双十一无门槛红包🧧
入口 https://u.jd.com/yd8ZUq7
活动时间：
更新时间2021-05-24 014:55
脚本兼容: QuantumultX, Surge,Loon, JSBox, Node.js
=================================Quantumultx=========================
[task_local]
#双十一无门槛红包🧧
1 0,12,18 * * * https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_hongbao.js, tag=双十一无门槛红包🧧, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "1 0,12,18 * * *" script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_hongbao.js,tag=双十一无门槛红包🧧
===================================Surge================================
双十一无门槛红包🧧 = type=cron,cronexp="1 0,12,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_hongbao.js
====================================小火箭=============================
双十一无门槛红包🧧 = type=cron,script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_hongbao.js, cronexpr="1 0,12,18 * * *", timeout=3600, enable=true
 */
let rebateCodes = ''
...
function getUA(){
    ...
    rebateCode = 'yd8ZUq7'
    if($.index != 1){
        let arr = [rebateCodes,'yd8ZUq7']
        rebateCode = arr[Math.floor(Math.random() * arr.length)] || rebateCode
        if(!rebateCode) rebateCode = 'yd8ZUq7'
    }
