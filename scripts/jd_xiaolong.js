...
[task_local]
#骁龙
10 9,17 * * * https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_xiaolong.js, tag=骁龙, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "10 9,17 * * *" script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_xiaolong.js,tag=骁龙
===================================Surge================================
骁龙 = type=cron,cronexp="10 9,17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_xiaolong.js
====================================小火箭=============================
骁龙 = type=cron,script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_xiaolong.js, cronexpr="10 9,17 * * *", timeout=3600, enable=true
 */
const $ = new Env('骁龙');
...
function takePostRequest(type) {
  ...
  switch (type) {
    ...
    case 'doTask':
      ...
      break;
    case 'doTask2':
      let aa = ['29b379e745cf4463a08f2efc70fc27a4','06f4ada464f546fa9a787b72b98e65be'];
