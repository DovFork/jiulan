/*
临近过期京豆兑换为喜豆
京豆过期 使用兑换喜豆 进行延时  注意喜豆只能在京喜app中使用
...
[task_local]
#临近过期京豆兑换为喜豆
1 9 * * * https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_exchangejxbeans.js, tag=临近过期京豆兑换为喜豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "1 9 * * *" script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_exchangejxbeans.js,tag=临近过期京豆兑换为喜豆
===================================Surge================================
临近过期京豆兑换为喜豆 = type=cron,cronexp="1 9 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_exchangejxbeans.js
====================================小火箭=============================
临近过期京豆兑换为喜豆 = type=cron,script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_exchangejxbeans.js, cronexpr="1 9 * * *", timeout=3600, enable=true
 */
const $ = new Env('临近过期京豆兑换为喜豆');
