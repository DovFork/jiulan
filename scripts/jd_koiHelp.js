...
未实现功能：领3张券功能
更新地址 https://github.com/he1pu/JDHelp/blob/main/jd_koiHelp.js
...
async function help(){
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        for (let j = 0; j < shareCodes.length; j++){
            let result = await requestApi('jinli_h5assist', {"redPacketId":shareCodes[j],"followShop":0,"random":random(0o00000, 999999),"log":"42588613~8,~0iuxyee","sceneid":"JLHBhPageh5"})
