...
author：LingFeng0918
[task_local]
#热血心跳,狂解压   10月16号应该可以参与瓜分
20 5 * * * jd_decompression.js, tag= 热血心跳,狂解压
================Loon==============
[Script]
cron "20 5 * * *" script-path= jd_decompression.js,tag= 热血心跳,狂解压
===============Surge=================
热血心跳,狂解压 = type=cron,cronexp="20 0 * * *",wake-system=1,timeout=3600,script-path= jd_decompression.js
============小火箭=========
热血心跳,狂解压 = type=cron,script-path= jd_decompression.js, cronexpr="20 0 * * *", timeout=3600, enable=true
*/
